...
def create_steering_control(packer, bus, apply_steer, lkas_enabled, hca_active_value=5):
  # hca_active_value: unused on MLB (always 7), accepted for call-site parity with pqcan
  values = {
